    ...
    module Search
      ...
      def self.permit_params(params)
        params.permit(
          ...
          :field_13, :field_14, :field_15, :field_16, :value_0, :value_1,
          :value_2, :value_3, :value_4, :value_5, :value_6, :value_7, :value_8,
          :value_9, :value_10, :value_11, :value_12, :value_13, :value_14,
          :value_15, :value_16, :boolean_0, :boolean_1, :boolean_2, :boolean_3,
          :boolean_4, :boolean_5, :boolean_6, :boolean_7, :boolean_8,
          :boolean_9, :boolean_10, :boolean_11, :boolean_12, :boolean_13,
          :boolean_14, :boolean_15, :boolean_16,
      ...
      private_class_method def self.parse_position(params, api)
        {}.tap do |ret|
      ...
      private_class_method def self.parse_facets_and_categories(params)
        {}.tap do |ret|
      ...
      private_class_method def self.parse_search(params)
        {}.tap do |ret|
          ...
          if params[:advanced]
            ...
            ret[:q] = if q_array.empty?
                        '*:*'
                      else
                        # Remove the last trailing boolean connective
                        q_array.join.chomp(' OR ').chomp(' AND ')
                      end
          elsif params[:q]
            # Simple search
            ret[:q] = params[:q]
