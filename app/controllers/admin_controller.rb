...
ENVIRONMENT_VARIABLES_TO_PRINT = {
  ...
  'admin.index.feature_flags':
    ['MAINTENANCE_MESSAGE', 'NLP_TOOL_PATH', 'ARTICLE_DATES_JOB_DISABLED',
     'COLLOCATION_JOB_DISABLED', 'COOCCURRENCE_JOB_DISABLED',
     'CRAIG_ZETA_JOB_DISABLED', 'EXPORT_CITATIONS_JOB_DISABLED',
     'NAMED_ENTITIES_JOB_DISABLED', 'NETWORK_JOB_DISABLED',
     'TERM_DATES_JOB_DISABLED', 'WORD_FREQUENCY_JOB_DISABLED'],
