...
class Hash
  ...
  #
  # This function will recursively convert any HashWithIndifferentAccess
  # classes found in the hash to plain hashes.  It is thus the (equally
  # recursive) counterpart to Hash#with_indifferent_access.
  #
